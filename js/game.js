...
const main_menu = {
  ...
  draw: function (ctx) {
    if (
      this.image_to_show_1 &&
      this.image_to_show_2 &&
      this.image_to_show_3 &&
      this.image_to_show_4 &&
      this.image_to_show_5
    ) {
      ctx.drawImage(
        this.image_to_show_5,
        this.x,
...
const objectPrototype = {
  init: function (assets) {
    ...
    this.position_y = [
      -32, 0, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352,
    ];
  ...
  choose_start_position: function () {
    let random_y_position =
      this.position_y[Math.floor(Math.random() * (this.position_y.length - 6))];
  ...
  choose_end_position: function () {
    let random_y_position =
      this.position_y[Math.floor(Math.random() * this.position_y.length)];
  ...
  get_object: function (score) {
    ...
    if (score <= 100) {
      ...
      this.speed = getRandomInRange(
        this.max_first_stage_speed,
        this.max_second_stage_speed
      );
      _11x18_chance = 10;
      _16x16_chance = 30;
      _16x32_chance = 10;
    ...
    if (choose <= _11x18_chance) {
      ...
      choose <=
      _11x18_chance + _16x16_chance + _16x32_chance + _20x32_chance
    ) {
      this.width = 20;
      this.height = 32;
...
const background = {
  ...
  draw: function (ctx) {
    ...
    if (this.image_to_show_far_layer_2) {
      ctx.drawImage(
        this.image_to_show_far_layer_2,
        this.x_far_layer_2,
        this.y,
        this.width,
        this.height
    ...
    if (this.image_to_show_close_layer) {
      ctx.drawImage(
        this.image_to_show_close_layer,
        this.x_close_layer,
        this.y,
        this.width,
        this.height
    ...
    if (this.image_to_show_close_layer_2) {
      ctx.drawImage(
        this.image_to_show_close_layer_2,
        this.x_close_layer_2,
        this.y,
        this.width,
        this.height
      );
